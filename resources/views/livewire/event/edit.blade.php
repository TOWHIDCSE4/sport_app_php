<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('event.creator_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="creator" name="creator" :options="$this->listsForFields['creator']"
            wire:model="event.creator_id" disabled />
        <div class="validation-message">
    ...
    <x-map lat="event.lat" lng="event.long" height="500px" place_name="event.location"
        data-long="{{ $event->long }}" data-lat="{{ $event->lat }}"></x-map>

<form wire:submit.prevent="submit" class="pt-3">
    ...
    {{--         Currencies --}}
    <div class="form-group {{ $errors->has('venue.currency') ? 'invalid' : '' }}">
        <label class="form-label required" for="currency">{{ trans('cruds.venue.fields.currency') }}</label>
        <x-select-list class="form-control" id="currency" name="currency" :options="$this->listsForFields['currencies']"
                       wire:model="venue.currency" />
        <div class="validation-message">
            {{ $errors->first('venue.currency') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.currency.fields.country_helper') }}
        </div>
    ...
    <div class="flex form-group">
        <div class="mr-8">
            <div class="form-group {{ $errors->has('venue.start_open_time') ? 'invalid' : '' }}">
                <label class="form-label required" for="name">{{ trans('cruds.venue.fields.start_open_time') }}</label>
        ...
        <div class="ml-5">
            <div class="form-group {{ $errors->has('venue.end_open_time') ? 'invalid' : '' }}">
                <label class="form-label required" for="name">{{ trans('cruds.venue.fields.end_open_time') }}</label>

...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('post/{post}/comment/{comment}/reply', [PostController::class, 'reply'])->name(
        'reply'
    );
    Route::get('post/{post}/comment', [PostController::class, 'comments'])->name(
        'comments'
    );
    ...
    Route::post('is-overlap-schedule', [
        EventController::class,
        'isOverlapSchedule',
    ...
    // Venue
    Route::get('venue/booking', [
        VenueController::class,
        'getAllVenueBooking',
    ])->name('getAllVenueBooking');
    Route::get('venue/booking/{id}', [
        VenueController::class,
        'getDetailVenueBooking',
    ])->name('getDetailVenueBooking');
    ...
    Route::post('venue/book', [
        VenueController::class,
        'createVenueBooking',
    ])->name('createVenueBooking');

    //Bookmark
    Route::get('bookmark/{type}', [
        BookmarkController::class,
        'getBookmark',
    ])->name('getBookmark');
    Route::get('bookmark/{type}/{status}', [
        BookmarkController::class,
        'getBookmark',
    ])->name('getEventBookmark');
    ...
    // LIKE
    Route::post('like', [LikeController::class, 'create'])->name('create');
    Route::delete('like/{target_id}', [LikeController::class, 'destroy'])->name(
        'destroy'
    );
});

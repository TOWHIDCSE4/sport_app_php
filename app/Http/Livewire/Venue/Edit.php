...
class Edit extends Component
{
    ...
    public function mount(Venue $venue)
    {
        ...
        $this->workdays = $venue->workdays()->pluck('code', 'code')->toArray();
        $this->workdays = array_keys($this->workdays) ?? [];
        $this->venue = $venue;
    ...
    protected function initListsForFields()
    {
        ...
        $this->listsForFields['workdays'] = WeekDay::orderBy('weight')->pluck('name', 'code')->toArray();
